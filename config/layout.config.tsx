...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  { heading: 'Keanggotaan' },
  {
    ...
    icon: Users,
    children: [
      { title: 'Pengelolaan Data', path: '/keanggotaan/data' },
      { title: 'Akurasi Data', path: '/keanggotaan/akurasi' },
    ],
  },
  { heading: 'Layanan' },
  {
  ...
  //   icon: TrendingUp,
  //   children: [
  //     { title: 'Laporan Keuangan', path: '/keuangan/laporan' },
  //     { title: 'Mekanisme Iuran', path: '/keuangan/mekanisme' },
  //   ],
  // },
  // { heading: 'Kolaborasi' },
  // {
  ...
  //   icon: Mail,
  //   children: [
  //     { title: 'Surat Dinas', path: '/kolaborasi/surat-dinas' },
  //     { title: 'Disposisi', path: '/kolaborasi/disposisi' },
  //     { title: 'Agenda Surat', path: '/kolaborasi/agenda' },
  //   ],
  // },
  ...
  //   icon: Settings,
  //   children: [
  //     { title: 'Manajemen Pendukung', path: '/administrasi/pendukung' },
  //     { title: 'Manajemen Arsip', path: '/administrasi/arsip' },
  //     { title: 'Manajemen User', path: '/administrasi/user' },
  //   ],
  // },
];
